...
public class FlySearchOneLegTripTest {
    ...
    public void beforeEachTest() throws MalformedURLException {
        ...
        member = createMember.createMember(AccountType.FLY_MEMBER);
    ...
    @DisplayName("Fly Search One Leg Trip KTEB To KBOS Test")
    public void flySearchOneLegTripKTEBToKBOSTest() {
