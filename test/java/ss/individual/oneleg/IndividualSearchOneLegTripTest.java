...
@Story("Individual Search One Leg Trip Test")
@ExtendWith({CustomBeforeTestExecution.class, CustomAfterTestExecution.class})
public class IndividualSearchOneLegTripTest {
    ...
    public void beforeEachTest() throws MalformedURLException {
        ...
        member = createMember.createMember(AccountType.INDIVIDUAL);
    ...
    @DisplayName("Individual Search One Leg Trip KTEB To KBOS Test")
    public void individualSearchOneLegTripKTEBToKBOSTest() {
